...
Unjail Validator
```
bcnad tx slashing unjail --from wallet --chain-id bitcanna-1 --gas auto -y
```
...
Withdraw Rewards
```
bcnad tx distribution withdraw-all-rewards --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```

Withdraw Rewards with Comission
```
bcnad tx distribution withdraw-rewards $(bcnad keys show wallet --bech val -a) --commission --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```

Delegate Token to your own validator
```
bcnad tx staking delegate $(bcnad keys show wallet --bech val -a) 100000000ubcna --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```

Delegate Token to other validator
```
bcnad tx staking redelegate $(bcnad keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 100000000ubcna --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```

Unbond Token from your validator
```
bcnad tx staking unbond $(bcnad keys show wallet --bech val -a) 100000000ubcna --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```

Send Token to another wallet
```
bcnad tx bank send wallet <TO_WALLET_ADDRESS> 100000000ubcna --from wallet --chain-id bitcanna-1
```
...
```
bcnad tx gov vote 1 yes --from wallet --chain-id bitcanna-1 --gas-adjustment 1.4 --gas auto --gas-prices="0.025ubcna" -y
```
