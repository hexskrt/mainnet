...
echo "     ██   ██ ██       ██ ██  ██  ██ ██ ██    ██ ██   ██ ██           ██"; 
echo "    ██   ██ ███████ ██   ██ ██   ████  ██████  ██████  ███████ ███████";
echo "         Automatic Installer for Meme Network | Chain ID : meme-1 ";
echo -e "\e[0m"
...
CHAIN=meme-1
FOLDER=.memed
VERSION=3d3bb097154af6a8eaa83f43e8e47dc91dcdb8b2
COSMOVISOR=cosmovisor
DENOM=umeme
REPO=https://github.com/MEMECosmos/meme
GENESIS=https://snapshot.hexnodes.co/meme/genesis.json
ADDRBOOK=https://snapshot.hexnodes.co/meme/addrbook.json
PORT=110
...
#Set Peers & Seeds
PEERS="$(curl -sS https://rpc.meme.hexnodes.co/net_info | jq -r '.result.peers[] | "\(.node_info.id)@\(.remote_ip):\(.node_info.listen_addr)"' | awk -F ':' '{print $1":"$(NF)}' | sed -z 's|\n|,|g;s|.$||')"
SEEDS="4db99dcb28062e4c73bc82352181103c1167326a@185.202.239.161:19656"
