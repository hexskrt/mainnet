#!/bin/bash
#
# // Copyright (C) 2023 Salman Wahib x NodeX Emperor Recoded By Hexnodes
#
...
echo "     ██   ██ ██       ██ ██  ██  ██ ██ ██    ██ ██   ██ ██           ██"; 
echo "    ██   ██ ███████ ██   ██ ██   ████  ██████  ██████  ███████ ███████";
echo "   Cosmovisor Automatic Installer for Dymension | Chain ID : mainnet-3 ";
echo -e "\e[0m"
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"20000000000$DENOM\"/" $HOME/$FOLDER/config/app.toml
